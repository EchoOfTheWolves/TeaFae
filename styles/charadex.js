...
let sheetPage = (id, pageName) => {
    return `https://docs.google.com/spreadsheets/d/${1KiKsz1aKvrq9wEsofw4sb1BlBI0dP8QuDa-jqmS0Bko}/gviz/tq?tqx=out:json&headers=1&tq=WHERE A IS NOT NULL&sheet=${pageName}`
};
